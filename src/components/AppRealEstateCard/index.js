import styles from "./AppRealEstateCard.module.scss";

export default function AppRealEstateCard({ item }) {
  return (
    <div className={styles.AppRealEstateCard}>
      <a href={`/real-estate/${item.id}`}>
        <figure>
        ...
        <div className={styles.AppRealEstateCard__Content}>
          <div className={styles.AppRealEstateCard__ContentTop}>
            <div className={styles.AppRealEstateCard__Price}>
              {item.price} ₾
            </div>
            <div className={styles.AppRealEstateCard__Address}>
              <span>
                <svg
                  width="20"
                  height="20"
